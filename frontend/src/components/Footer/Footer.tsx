import {  Facebook, Github, Instagram, LinkedIn,  } from '@/utils/icons'
import Image from 'next/image'

const socialIcons = [
  { href: 'https://github.com/mdjobayerarafat/', icon: Github },
  { href: 'https://www.linkedin.com/in/md-jobayer-arafat-a14b61284/', icon: LinkedIn },
  { href: '', icon: Instagram },
  { href: '', icon: Facebook },
]

const footerSections = [
  { title: 'Jobayer Arafat', href: '#home', content: 'Crafting high-performance web applications.' },
  ...
  <footer id="contact" className="bg-secondary px-4 text-white md:px-0">
    ...
    <div className="mx-auto max-w-[1200px] px-4 py-8">
      <div className="flex flex-col items-center justify-between md:flex-row">
        <p className="mb-4 text-sm font-normal md:mb-0">© 2025 Jobayer Arafat | Coded with 💜</p>
